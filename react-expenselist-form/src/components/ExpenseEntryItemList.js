...
class ExpenseEntryItemList extends React.Component {
   ...
   addItem=()=>{
     ...
     let newItem=document.formularz.fName.value;
     let newAmount= Number(document.formularz.fAmount.value);
     let newCategory = document.formularz.fCategory.value;
      ...
      //wyczyszcenie formularza
      document.formularz.fName.value="";
     document.formularz.fAmount.value=0;
     document.formularz.fCategory.value="";
     /*const form_for_reset= document.getElementById("dForm");
...
showForm=()=>{
document.getElementById("dForm").setAttribute("class", "dForm_show"); 
}
hideForm=()=>{
   document.getElementById("dForm").setAttribute("class", "dForm_hide"); 
}
   render() {
      ...
      return (
         ...
         <table onMouseOver={this.handleMouseOver}>
            ...
            <tbody>
               ...
               <tr colSpan="5"><td> <span onClick={this.showForm}>  Dodaj do listy </span>&nbsp;&nbsp;&nbsp;&nbsp;
                     <span onClick={this.wypiszID}>  wypiszID</span></td></tr>
            </tbody>
         </table>
         <div id="dForm" className="dForm_hide">
         <form name="formularz" id="formularz">
         <label>Name   </label><input name="fName" type="text"/><br/>
         <label>Amount  </label><input name="fAmount" type="number"/><br/>
         <label>Category  </label><input name="fCategory" type="text"/>

      </form>
      <button  onClick={this.addItem}>Dodaj do listy</button>
      </div>
      </div>
      );
   }
